...
class LanguageTag extends AbstractTag implements LazyTag {

    private final String key;

    LanguageTag(@NotNull final String namespace, @NotNull final Queue<String> arguments, final int childTextLength) {
    ...
    public String toString() {
        return "LanguageTag(\"%s\")".formatted(this.key);
    }
}
